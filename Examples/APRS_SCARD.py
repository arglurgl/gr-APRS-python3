...
import APRS_SCARD_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class APRS_SCARD(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "APRS - With Sound Card Input", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("APRS - With Sound Card Input")
        ...
        self.settings = Qt.QSettings("GNU Radio", "APRS_SCARD")
        ...
        self.fft_filter_xxx_0 = filter.fft_filter_fff(1, firdes.band_pass(10,samp_rate,1e3,2.6e3,100,window.WIN_BLACKMAN), 1)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.fft_filter_xxx_0.set_taps(firdes.band_pass(10,self.samp_rate,1e3,2.6e3,100,window.WIN_BLACKMAN))
...
def main(top_block_cls=APRS_SCARD, options=None):
